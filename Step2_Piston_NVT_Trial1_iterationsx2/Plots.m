...
figure (1)
    ...
    title('Behavior of Potential Energy with Piston (Trial 2)');
    ...
    ytickformat('%.2f')
    set(gca,'GridLineStyle',':');
    set(gca,'LineWidth', LW_0, 'FontSize', FS-30, 'FontWeight', 'normal', 'FontName', 'Times');
    set(get(gca, 'xlabel'), 'String', 'Time (ps)', 'Interpreter', 'Latex', 'FontSize', FS-30, 'FontName', 'Times');
    set(get(gca, 'ylabel'), 'String', 'Epot (kcal/mol)', 'FontSize', FS-30, 'FontName', 'Times');
    set(gcf, 'Position', [100, 100, 1000, 600]);

    exportgraphics(gcf, 'MoS2_NVT_Trial2_PE.png', 'Resolution', res, 'ContentType', 'vector');
